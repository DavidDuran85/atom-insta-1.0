...
class Animacion extends Component{
    constructor(props){
        super(props)
				this.myAnim =this.myAnimInit.bind(this);
		}
		myAnimInit = () => {
    ...
    render(){
        ...
        return(<div className="container container-anima"> {/* is-widescreen */}
					<div className="media">
					<div class="animation-wrapper" ref={this.myAnim}>
							<div class="sphere-animation">
								<svg class="sphere" viewBox="0 0 150 150" stroke="rgba(80,80,80,.35)">
									<defs>
